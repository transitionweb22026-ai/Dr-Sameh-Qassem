...
export async function generateMetadata({
  ...
  const pageResult = await getPageBySlug("reviews");
    ...
    <>
      <GlobalHeroSection
        ...
        secondaryCta={{
          ...
          href: hero?.secondary_cta_href || "#reviews",
        }}
        ...
        bg3DElement={hero?.bg_3d_element ?? "waves"}
        bookingCard={{
      ...
      <div id="reviews">
        <ReviewsGrid
          eyebrow={gridHeading.eyebrow}
          title={gridHeading.title}
          text={gridHeading.text}
          items={reviewItems}
        />
      </div>
