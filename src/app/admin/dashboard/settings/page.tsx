    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-brand-800/70">
          Shared across every page — the phone number and social links here update the hero booking
          card, footer, floating call/WhatsApp buttons, and the contact page all at once.
        </p>
      </div>
