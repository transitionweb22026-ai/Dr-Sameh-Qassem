        ...
        <StaggerGroup className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {stats.map((stat) => (
            <StaggerItem key={stat.label} direction="none">
              <div className="liquid-glass glass-interactive overflow-hidden rounded-3xl p-5 sm:p-6 flex items-center gap-4 h-full">
                ...
                <div className="text-start min-w-0 flex-1">
                  ...
                  />
                  <div className="text-xs sm:text-sm font-medium text-brand-800/70 leading-snug break-words">
                    {stat.label}
                  </div>
                </div>
              </div>
